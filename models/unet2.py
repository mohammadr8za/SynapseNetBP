...
class UNetPPGtoABP2(nn.Module):
    def __init__(self, dropout=0.1):
        super(UNetPPGtoABP2, self).__init__()
        ...
        self.conv6_e = nn.Conv1d(1024, 2048, kernel_size=3, stride=1, padding=1)

        # Define the decoder
        self.upconv1_d = nn.ConvTranspose1d(2048, 1024, kernel_size=2, stride=2)
        self.conv6_d = nn.Conv1d(2048, 1024, kernel_size=3, stride=1, padding=1)
