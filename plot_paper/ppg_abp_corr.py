...
plt.plot(raw_abp[:512], label="ABP Waveform", color='maroon'), plt.plot(raw_ppg[:512], label="PPG Wavefrom", color='b')
plt.axvline(x= 52, linestyle='--', color='orange')
plt.grid()
plt.legend(loc=1)
plt.axis(False)
...
plt.figure(figsize=(8, 3))
plt.plot(shifted_abp[:512], label="ABP Waveform", color='maroon'), plt.plot(raw_ppg[:512], label="PPG Wavefrom", color='b')
plt.axvline(x= 52, linestyle='--', color='orange')
plt.grid()
plt.legend(loc=1)
plt.axis(False)
